...
(() => {
    ...
    const component = {
        ...
        config: {
            Web3: ['ccm.load', 'https://cdn.jsdelivr.net/gh/ethereum/web3.js@1.2.0/dist/web3.min.js'],
            units: {
                wei:        'wei',
                gwei:       'Gwei',
                kwei:       'Kwei',
        ...
        Instance: function () {
            ...
            this.eth = {
                ...
                getBalance: (address, block = this.block.latest) =>
                ...
                contract: (jsonInterface, address = undefined, options = {}) => {

                    const instance = new this.web3.eth.Contract (jsonInterface, address, options);
                    ...
                    return {
                        ...
                        method: (method, args = []) => {
                            ...
                            return {
                                ...
                                call: (options = {}) =>
                                    instance.methods [method] (...args).call (options),

                                send: (options = {}) =>
                                    instance.methods [method] (...args).send (options),

                                encodeABI: () =>
                                    instance.methods [method] (...args).encodeABI (),

                                estimateGas: (options = {}) =>
                                    instance.methods [method] (...args).estimateGas (options)
                            };
                        },

                        events: (event, options = {}) =>
                            instance.events [event] (options),

                        once: (event, options = {}, callback) =>
                            instance.once (event, options, callback),
                        ...
                        deploy: options => {
                            ...
                            return {
                                ...
                                send: (_options) =>
                                    instance.deploy (options).send (_options),

                                encodeABI: () =>
                                    instance.deploy (options).encodeABI(),

                                estimateGas: (_options) =>
                                    instance.deploy (options).estimateGas(_options)
                            };
                        }
            ...
            this.utils = {
                ...
                toWei: (number, unit = this.units.ether) =>
